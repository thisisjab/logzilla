...
function LogLevelLabel({ level }: Props) {
    switch (level) {
        case 0: return <p className={`text-center text-sm text-gray-500 px-1 py-0.5 rounded uppercase font-extrabold`}>?</p>
        case 1: return <p className={`text-center text-sm text-gray-600 bg-gray-300 px-1 py-0.5 rounded uppercase`}>Debug</p>
        case 2: return <p className={`text-center text-sm text-blue-600 bg-blue-200 px-1 py-0.5 rounded uppercase`}>Info</p>
        case 3: return <p className={`text-center text-sm text-orange-900 bg-orange-300 px-1 py-0.5 rounded uppercase`}>Warning</p>
        case 4: return <p className={`text-center text-sm text-white bg-red-500 px-1 py-0.5 rounded uppercase`}>Error</p>
