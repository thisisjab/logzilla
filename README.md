...
Logzilla is a tiny tool for collecting and analyzing logs from various sources.
It works by defining a set of log sources and processing rules to extract and analyze the data.
